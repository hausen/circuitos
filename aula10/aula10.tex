...
\only<1>{\includegraphics[scale=0.9]{images/nand_univ1}}%
...
\only<2>{\includegraphics[scale=0.9]{images/nand_univ2_resp}}\\
Circuito 2
\end{minipage}

\vspace{12pt}

\only<1>{\includegraphics[scale=0.9]{images/nand_univ3}}%
...
\only<4>{\includegraphics{images/selector1}}%
\end{center}
